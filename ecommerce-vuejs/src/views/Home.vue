    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded"><a href="#start-shopping" class="bg-white px-2 py-2 rounded" id="heading">CS425-SWE
              Project. Online Shopping</a></h3>
          <div id="content" class="lead mb-0 bg-dark p-1 rounded">
            <h4>Team members:</h4>
            <ul>
              <li>Khosbayar Sandag</li>
              <li>Tamir Bold</li>
              <li>Temuujin Tsogt</li>
            </ul>
          </div>
        </header>
      </div>
...
#background-div {
  background: url(../assets/homecover.jpeg)
}
